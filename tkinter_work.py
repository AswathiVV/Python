...
def reg_form():
    ...
    def reg():
        con=sqlite3.connect("Python/sample1.db")    
    ...
    l1=tkinter.Label(win,text="Register form",bg="lightblue",fg="black")
    l1.place(x=180,y=10)
    ...
    b1=tkinter.Button(win,text="Register",bg="black",activebackground="gray",fg="white",activeforeground='green',padx=10,pady=10,command=reg)
